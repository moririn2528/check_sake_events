...
# from ..items import EventItem, OtherItem
# from ..utils.parse_url import get_id_from_calendar_url
...
#         event_id = get_id_from_calendar_url(response.url)
#         if event_id is None:
#             return None
...
#         if title is None:
#             return None
#         address = event.css("div.panel li.list-group-item a::text").get()
#         body = event.css("div.panel-body::text").getall()
#         links = event.css("div.panel-body a.linkthumb::attr(href)").getall()
